...
export class MainpageComponent implements OnInit {
  ...
  setAllDataLine1(dataNames, realNames,data,ratesLine) {
    ...
    this.myFirstTabArray.push({ name: realNames, values: value,alis:alis-currentDeger,satis:satis+currentDeger})
  }
 ...
 setAllDataLine2(dataNames, realNames,data,ratesLine) {
    ...
    let satis = parseFloat(data[''+dataNames]['satis'])
    var currentDeger = parseFloat(ratesLine);
    this.mySecondTabArray.push({ name: realNames, values: value,satis:satis+currentDeger,alis:alis-currentDeger})
  }
  ...
  setAllDataLine3(dataNames, realNames,data,ratesLine) {
    ...
    let satis = parseFloat(data[''+dataNames]['satis'])
    var currentDeger = parseFloat(ratesLine);
    this.myThirdTabArray.push({ name: realNames, values: value,alis:alis-currentDeger,satis:satis+currentDeger })
  }
